module arrays
    ...
    Real*8, allocatable, dimension(:) :: param_omega_b, param_omega_cdm, param_n_s, param_A_s,old_point
    Real*8, allocatable, dimension(:) :: param_H0,param_m_ncdm,B_beta,b_lambda,param_MG_beta2,current_point
