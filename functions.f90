...
subroutine write_ini_file_for_testing_precision(Cl_flag,bessel,q,kmaxtau0,index)
    ...
    If (lensing_flag) then
        ...
        write(UNIT_FILE1,'(a59)') 'number count contributions = density, rsd, doppler, lensing'
...
!    z_bin_bias(9),',',z_bin_bias(10)
    ...
    write(UNIT_FILE1,'(a31, 4(f10.8, a1),f10.8)') 'selection_magnification_bias = ', s_z_mag_bias(1),',',&
         s_z_mag_bias(2),',',s_z_mag_bias(3),',',s_z_mag_bias(4),',',s_z_mag_bias(5)!,',',z_bin_bias(6),',',z_bin_bias(7),',',z_bin_bias(8),',',&
!    z_bin_bias(9),',',z_bin_bias(10)
...
subroutine write_sh_file(name_ini_file)
  ...
  write(UNIT_FILE3,'(a16)') '#SBATCH -J CLASS'
  write(UNIT_FILE3,'(a13)') '#SBATCH -n  1'
  write(UNIT_FILE3,'(a13)') '#SBATCH -N  1'
  write(UNIT_FILE3,'(a20)') '#SBATCH -t 5-20:00:00'
