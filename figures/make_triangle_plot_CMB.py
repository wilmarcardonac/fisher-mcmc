...
samples_neglecting_lensing = loadMCSamples('../../../neglecting-lensing/fisher-mcmc/output/chains/NC-CMB-run3/mcmc_final_output',settings={'ignore_rows':0.})

samples_neglecting_lensing_only_auto = loadMCSamples('../../../neglecting-lensing-only-auto/fisher-mcmc/output/chains/NC-CMB-run3/mcmc_final_output',settings={'ignore_rows':0.})
...
g.triangle_plot([samples,samples_neglecting_lensing,samples_neglecting_lensing_only_auto],params=['omega_b','omega_cdm','n_s','ln1010As','H0','m_ncdm','nc_bias_b0','logcs2fld','w0_fld','e_pi','tau'],filled=True,contour_colors=['red','blue','gray'],legend_labels=['with lensing','without lensing','only auto-correlations'],legend_loc='upper right')
...
g.export('triangle_figure_NC_CMB.pdf')
