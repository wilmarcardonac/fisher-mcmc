...
for index in range(len(filenames)):
    ...
    os.rename("../output/chains/NC-CMB-run3/"+str(filenames[index]),"../output/chains/NC-CMB-run3/cmc_final_output_"+str(index+1)+".txt")
...
g.triangle_plot(samples,params=['omega_b','omega_cdm','n_s','ln1010As','H0','m_ncdm','nc_bias_b0','logcs2fld','w0_fld','e_pi','tau'],filled=True,contour_colors=['red'],legend_labels=['with lensing'],legend_loc='upper right')
