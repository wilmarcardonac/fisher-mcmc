...
f.plots_1d(samples,['omega_b','omega_cdm','n_s','ln1010As','H0','m_ncdm','nc_bias_b0','logcs2fld','w0_fld','f_pi','log10g_pi'])#,markers=[2.225e-2,1.198e-1,9.645e-1,2.20652e-9,6.727e1,6.0e-2,1.],nx=3)

f.export('../output/chains/1D_plots.pdf')

print '1D PLOTS CREATED'

g.triangle_plot(samples,params=['omega_b','omega_cdm','n_s','ln1010As','H0','m_ncdm','nc_bias_b0','logcs2fld','w0_fld','f_pi','log10g_pi'],filled=True)
...
for ax in g.subplots[7:,7]:
    ax.axvline(np.log10(4.3),color='black',ls='--')
...
for ax in g.subplots[7,0:7]:
    ax.axhline(np.log10(4.3),color='black',ls='dotted')
