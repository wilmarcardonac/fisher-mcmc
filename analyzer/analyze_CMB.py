...
g.triangle_plot(samples,params=['omega_b','omega_cdm','n_s','ln1010As','H0','m_ncdm','nc_bias_b0','logcs2fld','w0_fld','e_pi','tau'],filled=True,contour_colors=['gray'],legend_labels=['only auto-correlations'],legend_loc='upper right')
