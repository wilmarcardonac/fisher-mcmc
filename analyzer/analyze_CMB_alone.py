...
f.plots_1d(samples,['omega_b','omega_cdm','n_s','ln1010As','H0','m_ncdm','tau'])
...
g.triangle_plot(samples,params=['omega_b','omega_cdm','n_s','ln1010As','H0','m_ncdm','tau'],filled=True,contour_colors=['blue'],legend_labels=['without lensing'],legend_loc='upper right')
