Module fiducial
  ...
  Integer*4,parameter    :: number_of_parameters = 11       ! NUMBER OF COSMOLOGICAL PARAMETERS: 
  ! 10 FOR DEA MODEL ONLY INCLUDING e_pi; 
  ! 11 FOR DEA MODEL INCLUDING f_pi and g_pi; 
  ! 12 FOR DEA MODEL INCLUDING e_pi, f_pi, and g_pi; 
  ! 11 FOR DEA MODEL ONLY INCLUDING e_pi BUT JOINTLY ANALYSING NUMBER COUNTS AND CMB DATA; 
  ! 12 FOR DEA MODEL INCLUDING  f_pi and g_pi BUT JOINTLY ANALYSING NUMBER COUNTS AND CMB DATA; 
  ! 13 FOR DEA MODEL INCLUDING e_pi, f_pi, and g_pi BUT JOINTLY ANALYSING  NUMBER COUNTS AND CMB DATA
  ! 7  FOR LCDM MODEL INCLUDING MASSIVE NEUTRINOS AND CMB DATA ALONE
  Integer*4,parameter    :: DEA_MODEL = 2 ! 1: DEA MODEL ONLY INCLUDING e_pi; 2: DEA MODEL INCLUDING f_pi and g_pi; 3: DEA MODEL INCLUDING e_pi, f_pi, g_pi 
  ...
  Integer*4,parameter    :: UNIT_FILE1 = 80              ! UNIT FILE FOR AUXILIARY FILES
  Integer*4,parameter    :: UNIT_FILE2 = 81              ! UNIT FILE FOR AUXILIARY FILES
  Integer*4,parameter    :: UNIT_FILE3 = 82              ! UNIT FILE FOR AUXILIARY FILES 
...
!       'A_s         ','H_0         ','m_{\nu}     ','b_0         ','c_s^2       ','w_0         ','e_{\pi}     ','f_{\pi}     ',&
  ...
  Logical,parameter      :: include_fake_euclid_likelihood = .true. ! INCLUDE FAKE EUCLID LIKELIHOOD IN THE ANALYSIS IF SET IT TRUE
