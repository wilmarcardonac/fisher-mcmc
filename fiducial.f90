Module fiducial
  ...
  Integer*4,parameter    :: UNIT_FILE1 = 80              ! UNIT NUMBER FOR AUXILIARY FILES
  Integer*4,parameter    :: UNIT_FILE2 = 81              ! UNIT NUMBER FOR AUXILIARY FILES
  Integer*4,parameter    :: UNIT_FILE3 = 82              ! UNIT NUMBER FOR AUXILIARY FILES
