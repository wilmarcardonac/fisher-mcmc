Module fiducial
  ...
  Integer*4,parameter    :: steps_taken_before_definite_run = 0!10000 !100000 ! STEPS TAKEN BEFORE FREEZING COVARIANCE MATRIX
  ...
  Logical,parameter      :: start_from_fiducial = .false.!.true.!.false.    ! START MCMC ANALYSIS FROM FIDUCIAL POINT IF SET IT TRUE
