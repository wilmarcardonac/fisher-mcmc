Module fiducial
  ...
  Integer*4,parameter    :: number_iterations = 100000 !11000000        ! TOTAL NUMBER OF ITERATIONS IN MCMC RUN
...
!       'A_s         ','H_0         ','m_{\nu}     ','b_0         ','c_s^2       ','w_0         ','e_{\pi}     ','f_{\pi}     ',&
  ...
  Logical,parameter      :: include_fake_euclid_likelihood = .false. ! INCLUDE FAKE EUCLID LIKELIHOOD IN THE ANALYSIS IF SET IT TRUE
