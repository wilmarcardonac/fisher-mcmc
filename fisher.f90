...
!        write(UNIT_RANGES_FILE,*) 'MG_beta2    N    N ' 
     ...
     Else
        ...
        write(UNIT_RANGES_FILE,*) ''//trim(paramnames(4))//'    1.e-20    1.e-7 '
...
!           x_old(7) = genunf(real(MG_beta2-sigma_MG_beta2),real(MG_beta2+sigma_MG_beta2))     ! MG_beta2
     ...
     Do m=1,number_iterations
        ...
        Else
           ...
           plausibility(4) = (x_new(4) .lt. real(log(1.d-10))) .or. (x_new(4) .gt. real(log(1.d3))) ! limit As<3.d-9 but using log(10^10As)
